...
void PrinterSystemWidget::setupUi()
{
    ...
    m_memoryLayout->addWidget(m_memoryProgress, 0, Qt::AlignCenter);

    m_memoryLayout->addItem(new QSpacerItem(0, 0, QSizePolicy::Minimum, QSizePolicy::Expanding));
    ...
    m_memoryLayout->addWidget(m_memoryCapacityLabel, 0, Qt::AlignCenter);

    //Used label
    m_memoryUsedLabel = new QLabel(m_memoryGroupBox);
    m_memoryUsedLabel->setSizePolicy(QSizePolicy::Minimum, QSizePolicy::Minimum);
    m_memoryLayout->addWidget(m_memoryUsedLabel, 0, Qt::AlignCenter);
    ...
    m_memoryLayout->addWidget(m_memoryAvailableLabel, 0, Qt::AlignCenter);
