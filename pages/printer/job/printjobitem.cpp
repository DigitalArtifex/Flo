...
QKlipperPrintJob *PrintJobItem::printJob()
{
    return m_job;
}

void PrintJobItem::setPrintJob(QKlipperPrintJob *job)
{
    m_job = job;
...
void PrintJobItem::setStyleSheet(const QString &styleSheet)
{
    QFrame::setStyleSheet(styleSheet);
}

void PrintJobItem::onPrintJobStateChanged()
{
    QPixmap pixmap;
...
void PrintJobItem::onPrintJobCurrentLayerChanged()
{
...
void PrintJobItem::onPrintJobTotalLayersChanged()
{
...
void PrintJobItem::onInstanceNameChanged()
{
...
void PrintJobItem::closeButtonClickEvent()
{
    emit removeRequest(this);
}

void PrintJobItem::autoRemoveTimerTimeoutEvent()
{
    if(m_autoRemoveTimer)
    {
