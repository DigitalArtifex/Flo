...
BedTemperatureChart::~BedTemperatureChart()
{
    // if(m_axisX)
    //     m_axisX->deleteLater();
...
void BedTemperatureChart::setupUi()
{
    m_chart = new QChart();
...
void BedTemperatureChart::onUpdateTimerTimeout()
{
    QDateTime timestamp = QDateTime::currentDateTime();
...
void BedTemperatureChart::setStyleSheet(QString &styleSheet)
{
    QLinearGradient plotAreaGradient;
    plotAreaGradient.setStart(QPointF(0, 1));
    plotAreaGradient.setFinalStop(QPointF(1, 0));
